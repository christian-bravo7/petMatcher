...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/data.json":[function(require,module,exports) {
module.exports = {
  "pets": [{
    "name": "Carrot",
    "human": "Emily",
...
},{}],"src/petMatcher.js":[function(require,module,exports) {
"use strict";
...
*/
var petMatcher = function petMatcher(petData) {
  var humans = Object.keys(petData.humans).map(function (human) {
    return {
      name: human,
      location: petData.humans[human].location,
      pet: petData.pets.filter(function (pet) {
        if (pet.human === human) {
          return pet;
        }
      }).map(function (singlePet) {
        return _objectSpread({}, singlePet, {
          dislikes: singlePet.dislikes.map(function (dislikePet) {
            return dislikePet.slice(0, -1);
          }),
          likes: singlePet.likes.map(function (likePet) {
  ...
  var locations = Object.values(petData.humans).map(function (locationObj) {
    return locationObj.location;
  }).filter(function (location, index, list) {
...
var _petMatcher = _interopRequireDefault(require("./petMatcher"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// This will import your function from petMatcher.js and call it with
// the data provided.
document.getElementById("app").innerHTML = (0, _petMatcher.default)(_data.default);
},{"./styles.css":"src/styles.css","./data.json":"src/data.json","./petMatcher":"src/petMatcher.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
